 ...
 */
public abstract class ExecutionContext<C : AbstractRecordsCollection<*>> {
    /**
     * Запускает выполнение из переданного [источника][RequestReceiver].
     * Возвращается после окончания выполнения подпрограммы.
     */
    public abstract suspend fun subscript(receiver: RequestReceiver<BoundRequest<C, *>>)
     ...
     * @see AbstractHistory
     */
    internal abstract val history: RequestsHistory<BoundRequest<C, *>>
}