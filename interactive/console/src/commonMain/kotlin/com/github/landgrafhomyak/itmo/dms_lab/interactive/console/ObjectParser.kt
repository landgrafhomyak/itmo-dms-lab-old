...
class ObjectParser private constructor(
     ...
     * @see ObjectParser.Value.Simple
     * @see ObjectParser.Value.Compose
     */
    sealed interface Value {
         ...
         */
        @JvmInline
        value class Compose internal constructor(
    ...
    private inline fun saveObject(pos: Int, key: String, value: Value) {
    ...
    private inline fun saveString(pos: Int) {
        ...
        this.saveObject(
            pos, node.lastKey!!.also { node.lastKey = null }, Value.Simple(
    ...
    private inline fun popAndSaveStack(pos: Int) {
        ...
        this.saveObject(pos, this.stack.top.lastKey!!, Value.Compose(values))
